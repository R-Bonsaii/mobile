      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Container(
            child: Row(
              children: <Widget>[
                Text("Setting", style: TextStyle(fontSize: 23, fontWeight: FontWeight.w600, color: putih),),
              ],
            ),
          ),
        ...
        body: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text("General", style: TextStyle(fontSize: 27, color: putih, fontWeight: FontWeight.w600),
                ),
                Padding(
                  ...
                  child: Column(
                    children: [
                      Row(children: [
                        ...
                        Text("Pages", style: TextStyle(fontSize: 20,color: putih))
                      ],),
                      ...
                      GestureDetector(
                        ...
                        child: Row(children: [
                          ...
                          Text("Switch Theme", style: TextStyle(fontSize: 20,color: putih),)
                        ],),
                      )
                    ],
                  ),
